...
public class LiveGameActivity extends BaseContentActivity {
...
//
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initWebView(mWebView, Constants.LIVEGAME,mEmpty);
    }
...
//                if(Network.getNetWorkType(LiveGameActivity.this)==Network.NetworkStateNo){
//                    mEmpty.setVisibility(View.VISIBLE);
//                    mWebView.setVisibility(View.GONE);
//                }else {
